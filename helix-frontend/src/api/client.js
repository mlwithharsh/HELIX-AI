...
export const smartParksAPI = {
  ...
  registerDevice: (payload) => api.post('/api/smart-parks/devices', payload),
  ...
  listThresholds: () => api.get('/api/smart-parks/thresholds'),
  getHardwareContract: () => api.get('/api/smart-parks/hardware-contract'),
