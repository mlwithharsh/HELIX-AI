    ...
    <div className="pt-32 pb-24 px-6 max-w-5xl mx-auto space-y-24">
      ...
      <section className="space-y-8 text-center">
        <motion.div
          ...
          className="space-y-4"
        >
          <h1 className="text-4xl md:text-5xl font-bold">About HELIX</h1>
        ...
        >
          HELIX was created with a single purpose: to ensure that no one has to face their emotional struggles alone. We combine cutting-edge emotionally intelligent AI with a deeply human-centric design to provide a safe, non-judgmental space for expression.
        </motion.p>
      </section>
        ...
        <div className="flex flex-col md:flex-row items-start space-y-6 md:space-y-0 md:space-x-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 text-text-secondary leading-relaxed">
              <p>
                While HELIX is designed to provide emotional support and guidance, it is **not a replacement for professional therapy, counseling, or medical intervention.**
              </p>
              <p>
